...
from utils import laplacianStack,improved
...
def main(args):
    ...
    if reconstructStatus:
        ...
        cv2.imwrite('../outputs/out.jpg',output_image)
        improved(reconstructStatus)

if __name__ == '__main__':
    inputImageLocation = '../transformed/upscaledInput.jpg'
    outputImageLocation = '../transformed/out.jpg'

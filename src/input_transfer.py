...
def get_histograms(I, nlevels = 3, resolution = 256):
    ...
    LI            = laplacianStack(I,nLevels = nlevels + 1, useStack=False)
...
def main(args):
    ...
    # Ismall = cv2.resize((I.shape[1]/args.downsampling,I.shape[0]/args.downsampling),I)
